...
to setup
  clear-all
  reset-ticks
  set window_dimension  (sqrt(num_cells) / 2)
  resize-world min-pxcor max-pxcor min-pycor max-pycor
  resize-world (window_dimension * -1) (window_dimension) (window_dimension * -1) (window_dimension)
  set-patch-size (500 / window_dimension)
  set molecule-size (0.02 * window_dimension)

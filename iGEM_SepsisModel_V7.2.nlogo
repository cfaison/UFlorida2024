...
;  ]
  ...
  ask patches [
    ...
    set active-leukocyte-density ((pathogen-density + count pathogens) * pro-cytokine-density * 0.000000000001)
    set HSPC-density (HSPC-density - (anti-cytokine-density * 0.0000000000006))
    set suppressive-leukocyte-density ((pathogen-density + count pathogens) * anti-cytokine-density * 0.00000001)
  ]
